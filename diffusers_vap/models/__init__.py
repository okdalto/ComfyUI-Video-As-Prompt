...
if is_torch_available():
    ...
    _import_structure["transformers.cogvideox_transformer_3d_mot"] = ["CogVideoXTransformer3DMOTModel"]
    ...
    _import_structure["transformers.transformer_wan_mot"] = ["WanTransformer3DMOTModel"]
