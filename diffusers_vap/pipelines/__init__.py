...
try:
    ...
    _import_structure["wan"] = ["WanPipeline", "WanImageToVideoPipeline", "WanVideoToVideoPipeline", "WanImageToVideoMOTPipeline"]
try:
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .wan import WanImageToVideoPipeline, WanPipeline, WanVideoToVideoPipeline, WanImageToVideoMOTPipeline
